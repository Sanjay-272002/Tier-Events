    ...
    <header className="w-full flex items-center justify-between px-4 py-3 bg-white shadow-md">
      ...
      <div className="flex items-center gap-4">
        {!user ? (
          ...
          <>
            <span className="font-medium text-black cursor-pointer">{user.tierName}</span>
            {user.imageUrl ? (
              <img
                src={user.imageUrl}
                alt="User"
              ...
              <div className="w-8 h-8 rounded-full border-2 border-purple-500 bg-purple-100 flex items-center justify-center text-purple-700 font-bold text-lg cursor-pointer">
